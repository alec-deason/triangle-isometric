...
var vec__165298 = axis;
var a_x = cljs.core.nth.call(null,vec__165298,(0),null);
var a_y = cljs.core.nth.call(null,vec__165298,(1),null);
var a_z = cljs.core.nth.call(null,vec__165298,(2),null);
var vec__165301 = v;
var x = cljs.core.nth.call(null,vec__165301,(0),null);
var y = cljs.core.nth.call(null,vec__165301,(1),null);
var z = cljs.core.nth.call(null,vec__165301,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__165304,p__165305){
var vec__165312 = p__165304;
var u1 = cljs.core.nth.call(null,vec__165312,(0),null);
var u2 = cljs.core.nth.call(null,vec__165312,(1),null);
var u3 = cljs.core.nth.call(null,vec__165312,(2),null);
var vec__165315 = p__165305;
var v1 = cljs.core.nth.call(null,vec__165315,(0),null);
var v2 = cljs.core.nth.call(null,vec__165315,(1),null);
var v3 = cljs.core.nth.call(null,vec__165315,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__165318_SHARP_){
return (p1__165318_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__165319_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__165319_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__165320_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__165320_SHARP_,angle_lr),angle_ud);
...
var map__165327 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__165327__$1 = ((((!((map__165327 == null)))?((((map__165327.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__165327.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__165327):map__165327);
var up = cljs.core.get.call(null,map__165327__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__165327__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__165329 = cljs.core._EQ_;
var expr__165330 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__165329.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__165330))){
return straight;
} else {
if(cljs.core.truth_(pred__165329.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__165330))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__165329.call(null,quil.middlewares.navigation_3d.space,expr__165330))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__165329.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__165330))){
return up;
} else {
if(cljs.core.truth_(pred__165329.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__165330))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__165329.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__165330))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__165327,map__165327__$1,up,straight){
return (function (p1__165321_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__165321_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__165327,map__165327__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__165332_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__165332_SHARP_);
});})(initial_state))
);
});
/**
...
var map__165344_165355 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__165344_165356__$1 = ((((!((map__165344_165355 == null)))?((((map__165344_165355.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__165344_165355.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__165344_165355):map__165344_165355);
var vec__165345_165357 = cljs.core.get.call(null,map__165344_165356__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_165358 = cljs.core.nth.call(null,vec__165345_165357,(0),null);
var c_y_165359 = cljs.core.nth.call(null,vec__165345_165357,(1),null);
var c_z_165360 = cljs.core.nth.call(null,vec__165345_165357,(2),null);
var vec__165348_165361 = cljs.core.get.call(null,map__165344_165356__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_165362 = cljs.core.nth.call(null,vec__165348_165361,(0),null);
var u_y_165363 = cljs.core.nth.call(null,vec__165348_165361,(1),null);
var u_z_165364 = cljs.core.nth.call(null,vec__165348_165361,(2),null);
var vec__165351_165365 = cljs.core.get.call(null,map__165344_165356__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_165366 = cljs.core.nth.call(null,vec__165351_165365,(0),null);
var p_y_165367 = cljs.core.nth.call(null,vec__165351_165365,(1),null);
var p_z_165368 = cljs.core.nth.call(null,vec__165351_165365,(2),null);
quil.core.camera.call(null,p_x_165366,p_y_165367,p_z_165368,(p_x_165366 + c_x_165358),(p_y_165367 + c_y_165359),(p_z_165368 + c_z_165360),u_x_165362,u_y_165363,u_z_165364);
